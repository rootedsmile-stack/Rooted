  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`backdrop-blur-lg rounded-none transition-all duration-300 ${
            isScrolled
              ? 'bg-teal-900/95 shadow-luxury-lg'
              : 'bg-teal-900/80 shadow-luxury'
          }`}
        >
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/" className="flex items-center gap-3 group">
                <div className="w-10 h-10 bg-gradient-to-br from-gold-400 to-gold-600 rounded-full flex items-center justify-center transition-transform group-hover:scale-110 shadow-glow-gold">
                  <span className="text-white font-display font-bold text-xl">R</span>
                </div>
                <div>
                  <h1 className="text-xl font-display font-semibold text-stone-100 group-hover:text-gold-400 transition-colors tracking-wide">
                    Rooted Smile
                  </h1>
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                <Link
                  href="/shop"
                  className="px-6 py-2.5 bg-gradient-to-r from-gold-500 to-gold-600 text-white rounded-none font-medium hover:from-gold-600 hover:to-gold-700 transition-all shadow-lg hover:shadow-glow-gold tracking-wide text-sm uppercase"
                >
                  Shop Now
                </Link>
              </div>
              ...
              <div className="md:hidden mt-6 pt-6 border-t border-white/10">
                <nav className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-4 pt-4 border-t border-white/10">
                    ...
                    <Link
                      href="/shop"
                      className="flex-1 px-6 py-2.5 bg-gradient-to-r from-gold-500 to-gold-600 text-white rounded-none font-medium text-center hover:from-gold-600 hover:to-gold-700 transition-all tracking-wide text-sm uppercase"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Shop Now
                    </Link>
